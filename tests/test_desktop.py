"""Tests for scraper.sources.desktop — RSS + curated milestones."""

import requests as req_lib
import responses

from scraper.sources.desktop import fetch, _fetch_from_rss, ANTHROPIC_NEWS_RSS, CURATED_ITEMS
...
class TestFetchFromRss:
    ...
    def test_filters_by_keywords(self, rss_xml):
        ...
        # Only the desktop-related item should match
        titles = [i["title"] for i in items]
        assert "Claude Desktop app adds cowork mode" in titles
